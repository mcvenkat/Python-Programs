...
neptune_orbit=p.circle(x=0, y=0, radius=1.2, line_color='yellow',line_alpha=0.5,fill_color=None, line_width=2)
...
neptune=p.circle(x='x_jupiter', y='y_jupiter', size=16, fill_color='yellow', line_color=None, fill_alpha=0.6, source=neptune_source)
